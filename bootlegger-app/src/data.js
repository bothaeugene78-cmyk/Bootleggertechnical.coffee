...
export const SELF_HELP_GUIDES = [
  {
    id: "G001", title: "Nouva Simonelli — Daily Cleaning", category: "Cleaning", icon: "🧹",
  ...
  {
    id: "G002", title: "Espresso Machine — Descaling", category: "Maintenance", icon: "💧",
  ...
  {
    id: "G003", title: "Mythos Grinder — Daily & Weekly", category: "Cleaning", icon: "⚙️",
  ...
  {
    id: "G004", title: "Nouva Simonelli — Pressure Check", category: "Inspection", icon: "⚡",
  ...
  {
    id: "G005", title: "SanRemo — Steam Wand Care", category: "Cleaning", icon: "🌡️",
  ...
  {
    id: "G006", title: "Reporting a Fault / Raising a Callout", category: "Admin", icon: "📋",
  ...
  {
    id: "G007", title: "Water Filtration — Filter Check", category: "Maintenance", icon: "🚰",
